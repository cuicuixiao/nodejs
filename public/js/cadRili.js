...
//	//$(a).html("上班");
//}
$(".zmian td").click(function(){
    var a= $(this).children("p").html();
    var b= $(this).children("span").html();
    $(".ztitle").html("2017-10-"+a);
    if(b=="上班"){
        $(this).children("span").html("休息");
    }else{
        $(this).children("span").html("上班");
    }
});